...
type AppProps ={
        ...
        arrow:any,
        alt:string,
        children: false | React.ReactElement<AppProps>
    
}

function HomeStoryCard(props:AppProps) {
        ...
        <Grid item lg={3} md={3} sm={6} xs={12} className='story-cont' >
            <Grid container direction='row' >
                ...
                {/* <Grid item xs={12} className='img-cont'> */}
                    ...
                    <h4>{props.author}</h4>
                    <hr/>
                    <Button buttonSize='btn--wide' buttonStyle={props.btnStyle} link={props.link} type={'submit'}>
