                    ...
                    <div
                        ...
                        <div className="pricing-container-card" data-aos='fade-up' data-aos-duration='1500' >
                            <div className="pricing-container-cardInfo">
                                ...
                                <ButtonPrices  buttonSize='btnP--wide' buttonStyle='btnP--primary' type='button' link=''>
                                PICK PLAN
                                </ButtonPrices>
                            </div>
                        </div>
                        <div className="pricing-container-card" data-aos='fade-up' data-aos-duration='1500' >
                            <div className="pricing-container-cardInfo">
                                ...
                                <h2>{checked?'$390.00':'$39.99'}</h2>
                                       <p>per {checked? 'year':'month'}</p>
                                <ButtonPrices  buttonSize='btnP--wide' buttonStyle='btnP--outline'  type='button' link=''>
                                PICK PLAN
                                </ButtonPrices>
                            </div>
                        </div>
