...
type AppProps ={
        ...
        classes:string, index:number, title:string,text:string, btnStyle:string, link:string, btn:string, arrow:number,
    
}

function HomeIntroCard(props:AppProps) {
        ...
        <div>
            <Grid container direction='row' className={props.classes} data-aos='fade-up' data-aos-duration='1500'>
                ...
                <Grid item lg={5} sm={7} xs={12} className='text-col'>
                    ...
                    <p>{props.text}</p>
                 <Button buttonSize='btn--wide' buttonStyle={props.btnStyle} link={props.link} type='button'>
